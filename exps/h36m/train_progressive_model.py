...
from hmpdata import Human36MsiMLPe, Human36MDatasetConfig
...
if __name__ == "__main__":
    ...
    data_cfg = cfg['data']
    dataset = Human36MsiMLPe(
        data_dir=args.data_dir,
        config=Human36MDatasetConfig(h36m_input_length=data_cfg['h36m_input_length'], h36m_target_length_train=data_cfg['h36m_target_length_train']),
        split_name="train",
